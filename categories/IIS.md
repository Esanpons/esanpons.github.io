...
layout: page
title: IIS
permalink: /blog/categories/IIS/
---

<h5> Categoria : {{ page.title }} </h5>

<div class="card card-categories-list">
    {% assign articles = site.articles | where: "category", "IIS" %}
    {% assign sorted_articles = articles %}
    {% assign all_posts = site.categories.IIS | concat: sorted_articles | sort: 'date' | reverse%}
