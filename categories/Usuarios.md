...
layout: page
title: Usuarios
permalink: /blog/categories/Usuarios/
---

<h5> Categoria : {{ page.title }} </h5>

<div class="card card-categories-list">
    {% assign articles = site.articles | where: "category", "Usuarios" %}
    {% assign sorted_articles = articles %}
    {% assign all_posts = site.categories.Usuarios | concat: sorted_articles | sort: 'date' | reverse%}
