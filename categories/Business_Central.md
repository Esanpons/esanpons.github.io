...
<div class="card card-categories-list">
    {% assign articles = site.articles | where: "category", "Business_Central" %}
    {% assign sorted_articles = articles %}
    {% assign all_posts = site.categories.Business_Central | concat: sorted_articles | sort: 'date' | reverse%}
