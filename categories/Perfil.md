...
layout: page
title: Perfil
permalink: /blog/categories/Perfil/
---

<h5> Categoria : {{ page.title }} </h5>

<div class="card card-categories-list">
    {% assign articles = site.articles | where: "category", "Perfil" %}
    {% assign sorted_articles = articles %}
    {% assign all_posts = site.categories.Perfil | concat: sorted_articles | sort: 'date' | reverse%}
